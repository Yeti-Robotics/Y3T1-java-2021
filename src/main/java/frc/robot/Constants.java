...
public final class Constants {
    ...
    public static final int kLeftMotor3Port = 13;
    public static final int kRightMotor1Port = 0;
    public static final int kRightMotor2Port = 1;
    public static final int kRightMotor3Port = 2;

    public static final double ksVolts = 1.41;
    public static final double kvVoltSecondsPerMeter = 2.76;
    public static final double kaVoltSecondsSquaredPerMeter = 0.0358;

    public static final double kPDriveVel = 0.483;

    public static final double kTrackwidthMeters = 1.481628671028307;
    ...
    public static final double kEncoderDistancePerPulse = DISTANCE_PER_PULSE;
