...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(15, Sides.LEFT, false);

    WPI_VictorSPX leftFollowerID14 = setupWPI_VictorSPX(14, Sides.FOLLOWER, false);
    leftFollowerID14.follow(leftMotor);
    WPI_VictorSPX leftFollowerID13 = setupWPI_VictorSPX(13, Sides.FOLLOWER, false);
    leftFollowerID13.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(0, Sides.RIGHT, false);
    WPI_VictorSPX rightFollowerID1 = setupWPI_VictorSPX(1, Sides.FOLLOWER, false);    
    rightFollowerID1.follow(rightMotor);
    WPI_VictorSPX rightFollowerID2 = setupWPI_VictorSPX(2, Sides.FOLLOWER, false);    
